        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kimge1 = table.Column<string>(nullable: true),
                    Kimge2 = table.Column<string>(nullable: true),
                    Kimge3 = table.Column<string>(nullable: true),
                    Kimge4 = table.Column<string>(nullable: true),
                    Kimge5 = table.Column<string>(nullable: true),
                    What1 = table.Column<string>(nullable: true),
                    What2 = table.Column<string>(nullable: true),
                    What3 = table.Column<string>(nullable: true),
                    AvtorName = table.Column<string>(nullable: true),
                    AvtorInfo = table.Column<string>(nullable: true),
                    AvtorImgUrl = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
